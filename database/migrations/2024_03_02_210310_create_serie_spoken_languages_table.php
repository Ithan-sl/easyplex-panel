...
class CreateSerieSpokenLanguagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('serie_spoken_languages', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('serie_spoken_languages');
    }
}
