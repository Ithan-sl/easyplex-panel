...
class SerieController extends Controller
{
    ...
    public function data()
    {
        ...
        $query = Serie::withOnly(['genres.genre', 'seasons' => function ($query) {
        ...
        if ($request->serie['certifications']) {
            ...
            foreach ($request->serie['certifications'] as $network) {
                if (!isset($network['certification_id'])) {
                    ...
                    $find->fill($network);
                    $find->save();
                    $movieNetwork = SerieCertification::query()->where('serie_id', $serie->id)
        ...
        if ($request->serie['belongs_to_collection']) {
            ...
            foreach ($request->serie['belongs_to_collection'] as $network) {
                if (!isset($network['collection_id'])) {
                    ...
                    $find->fill($network);
                    $find->save();
                    $movieNetwork = SerieCollection::query()->where('serie_id', $serie->id)
