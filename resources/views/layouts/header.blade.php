...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" aria-label="navbar">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <span  class="nav-profile-name">Version : {{ $settings->webpanelversion }}</span>
                </a>
...
<nav class="sidebar sidebar-offcanvas" id="sidebar" aria-label="sidbar" data-enable-remember="true">
        <ul class="nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.server')}}">
                    ...
                    <span class="menu-title">Servers & DRM</span>
                </a>
            </li>
